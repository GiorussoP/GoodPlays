...
def test_create_progress_success(client):
    ...
    user_response = client.post("/users/", json={"username": "progressuser", "email": "progress@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Progress Game", "developer": "Dev"})
...
def test_create_progress_duplicate(client):
    # Criar usuário e jogo primeiro
    user_response = client.post("/users/", json={"username": "progressuser_dup", "email": "progress_dup@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Progress Game Dup", "developer": "Dev"})
...
def test_get_progress_success(client):
    ...
    user_response = client.post("/users/", json={"username": "progressuser2", "email": "progress2@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Progress Game 2", "developer": "Dev 2"})
    ...
    response = client.get(f"/progress/by-user-and-game/{user_id}/{game_id}")
    assert response.status_code == 200
    data = response.json()
...
def test_get_user_progress_success(client):
    ...
    user_response = client.post("/users/", json={"username": "userprogress", "email": "userprogress@test.com", "password": "pass123"})
    game1_response = client.post("/games/", json={"title": "Game 1", "developer": "Dev 1"})
    game2_response = client.post("/games/", json={"title": "Game 2", "developer": "Dev 2"})
    ...
    response = client.get(f"/progress/by-user/{user_id}")
    assert response.status_code == 200
    data = response.json()
    assert len(data) == 2
...
def test_get_game_progress_success(client):
    # Criar usuários e jogo
    user1_response = client.post("/users/", json={"username": "user1progress", "email": "user1progress@test.com", "password": "pass123"})
    user2_response = client.post("/users/", json={"username": "user2progress", "email": "user2progress@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Shared Game", "developer": "Dev"})
    ...
    response = client.get(f"/progress/by-game/{game_id}")
    assert response.status_code == 200
    data = response.json()
    assert len(data) == 2
...
def test_get_game_progress_not_found(client):
...
def test_update_progress_success(client):
    # Criar usuário, jogo e progresso
    user_response = client.post("/users/", json={"username": "progressuser3", "email": "progress3@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Progress Game 3", "developer": "Dev 3"})
    ...
    get_response = client.get(f"/progress/by-user-and-game/{user_id}/{game_id}")
    ...
    response = client.put(f"/progress/{progress_id}", json=update_data)
    assert response.status_code == 200
    data = response.json()
    assert "message" in data
...
def test_delete_progress_success(client):
    # Criar usuário, jogo e progresso
    user_response = client.post("/users/", json={"username": "progressuser4", "email": "progress4@test.com", "password": "pass123"})
    game_response = client.post("/games/", json={"title": "Progress Game 4", "developer": "Dev 4"})
...
def test_delete_progress_not_found(client):
